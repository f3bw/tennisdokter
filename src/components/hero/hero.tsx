            ...
            <div className={styles.container}>
                <div className={styles.logo}>
                    <div className={styles['logo-placeholder']}>
                        <span className={styles['logo-text']}>TD</span>
                    </div>
                    <h1 className={styles['logo-title']}>De Tennisdokter</h1>
                </div>
                ...
                <p className={styles.description}>
                    Stuur een video van je slag, ontvang professionele analyse
                    en tips terug. Snel, persoonlijk en betaalbaar.
                </p>
